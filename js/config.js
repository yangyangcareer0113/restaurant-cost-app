...
const PRICING_MULT = {
  '純鍋底': 4, '一般加點': 3.2, '比價肉品': 2.2, '費工副銷': 4, '配料主食': 5, '利潤飲品': 7,
...
function pricingRoleOf(o) {
  ...
  if (/鍋底|湯底|湯頭|純鍋|清湯鍋|個人鍋|共鍋|潤鍋|藥膳鍋|養生鍋|鍋$/.test(s)) {
    ...
    role = '利潤飲品';
  } else if (/菜盤|蔬菜|高麗菜|白菜|茼蒿|青菜|菇盤|金針菇|鴻喜菇|香菇|杏鮑菇|木耳|豆腐|凍豆腐|油豆腐|王子麵|科學麵|意麵|烏龍麵|冬粉|米粉|白飯|米飯|飯$|年糕|粿|玉米|南瓜|地瓜|醬料|沾醬/.test(s)) {
    role = '配料主食';
  }
